...
import kotlinx.android.synthetic.main.fragment_intermediate_quiz.*
 ...
 *
 */
class IntermediateQuizFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_intermediate_quiz, container, false)
        context = this
        btn_next = view.findViewById<Button>(R.id.btn_next_intermediate)
    ...
    fun UpdateQuestion() {
        val selected = int_rg_choice.checkedRadioButtonId
        if (selected == -1) {
        ...
        if (index < Questionlist.size) {
            ...
            index++
            if (index < Questionlist.size) {
                tvQnsInt.text = Questionlist[index].Question
                int_rb_choice1.text = Questionlist[index].Option1
                int_rb_choice2.text = Questionlist[index].Option2
                int_rb_choice3.text = Questionlist[index].Option3
                int_rb_choice4.text = Questionlist[index].Option4
                int_rg_choice.clearCheck()
                if ((index + 1) == Questionlist.size)
                    btn_next_intermediate.text = "Finish"
            }
            else {
    ...
    internal inner class getQuestion : AsyncTask<Void, Void, String>() {
        ...
        override fun doInBackground(vararg params: Void?): String {
            if (isNetworkAvailable()) {
                ...
                val url = "https://houseofcasesg.website/image-upload/intermediatequiz.json"
